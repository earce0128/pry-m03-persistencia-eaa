package mx.com.qtx.cotizadorv1ds.persistencia.jdbc;
...
/**
 * Clase de utilidad para obtener conexiones a la base de datos. ¡ADAPTAR CON
 * CREDENCIALES Y CONFIGURACIÓN REALES!
 */
public class DatabaseConnector {
    // Reemplaza con tu URL, usuario y contraseña de MySQL
    private static final String DB_URL = "jdbc:mysql://localhost:3306/cotizador_eaa?useSSL=false&serverTimezone=UTC";
    private static final String DB_USER = "root";
    private static final String DB_PASSWORD = "rootAdmin2022#";
